...
(function() {
	...
	/** @ngInject */
	function WorkersdetailCtrl($scope, $filter, $localStorage, editableOptions, editableThemes, WorkerService, workermodels, workertypelist, allgroups, allmenus, $http, $timeout, $uibModal, baProgressModal,md5,$window) {
